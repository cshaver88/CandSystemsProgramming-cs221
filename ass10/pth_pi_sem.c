 ...
 *
 * Compile:  gcc -g -Wall -o pth_pi_sem pth_pi_sem.c -lm -lpthread
 * Run:      pth_pi_sem <number of threads> <n>
 ...
 *    2.  This version uses a local sum on each thread and a semaphore to
